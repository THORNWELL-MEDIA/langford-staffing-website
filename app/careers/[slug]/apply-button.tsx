...
export function ApplyButton({
  ...
  const triggerVariant =
    variant === 'primary'
      ? 'bg-brand-saffron text-white hover:-translate-y-0.5 hover:bg-brand-saffron-dark'
      : 'border border-brand-navy/20 bg-white text-brand-navy hover:border-brand-navy/40 hover:bg-white'
...
function ApplyModal({
  ...
  return createPortal(
    <>
      <div
        aria-hidden="true"
        className="fixed inset-0 z-40 bg-brand-navy/70 backdrop-blur-sm"
      />
      <div
        role="dialog"
        aria-modal="true"
      ...
      >
        <div className="relative flex w-full max-w-2xl max-h-full sm:max-h-[90vh] flex-col overflow-hidden rounded-2xl bg-white shadow-2xl">
          <div className="flex shrink-0 items-center justify-between border-b border-brand-line/10 bg-white px-5 py-4 pt-6">
            <div>
              <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-brand-saffron">
                Apply Now
              </p>
              <h2
                id="apply-modal-title"
                className="mt-0.5 text-[18px] font-bold text-brand-navy"
              >
                {role}
              </h2>
            </div>
            <button
              onClick={onClose}
              className="p-1 text-brand-ink/40 transition-colors hover:text-brand-navy"
              aria-label="Close"
            >
          ...
          <div className="overflow-y-auto p-5 pb-8">
            {status === 'success' ? (
              <div className="flex flex-col items-center justify-center gap-4 py-8 text-center">
                <CheckCircle2 className="h-12 w-12 text-brand-saffron" />
                <h3 className="text-xl font-bold text-brand-navy">
                  Application Received
                </h3>
                <div className="space-y-3 text-sm text-brand-ink/70 max-w-md">
                  <p>Thank you for applying to Langford Staffing.</p>
                  <p>
                    ...
                    <a
                      ...
                      className="font-semibold text-brand-saffron hover:underline"
                    >
                      Langford Staffing
                    </a>
                  ...
                  <p>
                    Langford Staffing is an equal opportunity employer. All applications are reviewed based on qualifications, experience, and role requirements.
                  </p>
                ...
                <button
                  onClick={onClose}
                  className="mt-4 rounded-full bg-brand-navy px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-brand-navy/90"
                >
                  Close
                </button>
              </div>
              ...
              <>
                {(() => {
                  const getInputClass = (name: string) => `w-full rounded-lg border ${fieldErrors[name] ? 'border-red-500' : 'border-brand-line/20'} bg-white/30 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-gold-600`
                  return (
                    ...
                    `}} />
                          <div className={`flex w-full overflow-hidden rounded-lg border ${fieldErrors['phone'] ? 'border-red-500' : 'border-brand-line/20'} bg-white/30 px-3 focus-within:ring-2 focus-within:ring-gold-600`}>
                            <PhoneInput
                              international
                          ...
                          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                              ...
                              <div className="relative">
                                ...
                                />
                                <span className="absolute inset-y-0 right-3 flex items-center text-sm font-semibold text-brand-ink/40 pointer-events-none">
                                  GB
                                </span>
                              </div>
                        ...
                        <>
                          <div>
                            ...
                            <select
                              ...
                              className="w-full rounded-lg border border-brand-line/20 bg-white/30 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-gold-600"
                            >
                              <option value="">Select an option</option>
                              ...
                              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                ...
                                <div>
                                  ...
                                  <input
                                    ...
                                    className={`w-full rounded-lg border ${fieldErrors['wsib_certificate'] ? 'border-red-500' : 'border-brand-line/20'} bg-white/30 px-3 py-2 text-sm file:mr-4 file:rounded-full file:border-0 file:bg-brand-saffron/10 file:px-4 file:py-1 file:text-xs file:font-semibold file:text-brand-saffron hover:file:bg-brand-saffron/20 focus:outline-none focus:ring-2 focus:ring-gold-600`}
                                  />
                          ...
                          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                              ...
                              <input
                                ...
                                className={`w-full rounded-lg border ${fieldErrors['attached_portfolio'] ? 'border-red-500' : 'border-brand-line/20'} bg-white/30 px-3 py-2 text-sm file:mr-4 file:rounded-full file:border-0 file:bg-brand-saffron/10 file:px-4 file:py-1 file:text-xs file:font-semibold file:text-brand-saffron hover:file:bg-brand-saffron/20 focus:outline-none focus:ring-2 focus:ring-gold-600`}
                              />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          required
                          accept=".pdf,.doc,.docx"
                          className={`w-full rounded-lg border ${fieldErrors['resume'] ? 'border-red-500' : 'border-brand-line/20'} bg-white/30 px-3 py-2 text-sm file:mr-4 file:rounded-full file:border-0 file:bg-brand-saffron/10 file:px-4 file:py-1 file:text-xs file:font-semibold file:text-brand-saffron hover:file:bg-brand-saffron/20 focus:outline-none focus:ring-2 focus:ring-gold-600`}
                        />
                      ...
                      <button
                        ...
                        className="mt-2 flex w-full items-center justify-center gap-2 rounded-full bg-brand-saffron py-3 text-sm font-bold text-white transition-colors hover:bg-brand-saffron-dark disabled:opacity-60"
                      >
...
export function StickyApplyButton(props: Props) {
  ...
  return (
    <div
      className={`fixed bottom-0 left-0 right-0 z-40 border-t border-brand-line/20 bg-white p-4 pb-[calc(1rem+env(safe-area-inset-bottom))] shadow-[0_-4px_12px_rgba(0,0,0,0.08)] lg:hidden transition-transform duration-300 ease-in-out ${
